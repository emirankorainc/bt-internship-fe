    ...
    <div className="h-full w-full p-4 sm:p-6 lg:p-8">
      <div className="mx-auto h-full w-full max-w-7xl pb-6 sm:pb-8">
        ...
        <div className="mb-6 sm:mb-8 mt-4 sm:mt-6">
          <h1 className="text-foreground mb-2 text-2xl font-bold sm:text-3xl">Buckets</h1>
        ...
        {/* User Buckets  */}
        <h1 className="w-full text-start text-xl font-semibold sm:text-2xl">User Buckets</h1>
        <div className="mt-6 sm:mt-12 w-full">
          {isLoading && <p>Loading...</p>}

          {!filteredUserBuckets && (
            <h1 className="w-full text-center text-xl text-red-600 sm:text-2xl">Failed to load user buckets</h1>
          )}

          {filteredUserBuckets?.length === 0 && (
            <h1 className="text-muted w-full text-center text-xl sm:text-2xl">No assigned user buckets</h1>
          )}
        ...
        {/* All Buckets */}
        <h1 className="mt-6 sm:mt-8 w-full text-start text-xl font-semibold sm:text-2xl">All Buckets</h1>
        <div className="my-6 sm:my-12 w-full">
          {isLoading && <p>Loading...</p>}
